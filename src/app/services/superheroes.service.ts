...
export class SuperheroesService {
	...
	modifySuperhero(id: string, updatedSuperhero: superheroe): Observable<{ success: boolean }> {
	...
	deleteSuperhero(id: string): Observable<{ success: boolean }> {
		const filteredSuperheroes = this.superheroes_mock().filter((hero) => hero.id !== id);
